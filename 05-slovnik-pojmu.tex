...
\newacronym{uml}{UML}{\textbf{U}nified \textbf{M}odeling \textbf{L}anguage --  grafický jazyk pro vizualizaci,
specifikaci, návrh a dokumentaci softwarových systémů.}

\newacronym{ds}{DS}{\textbf{D}atová \textbf{S}truktura -- objekt v paměti počítače umožňující práci daty}
