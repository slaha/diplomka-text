...
%\usepackage{url}
%\usepackage{amsmath}
%\usepackage[left=3cm,right=2cm,top=3cm,bottom=2.5cm]{geometry}
%\author{Jan Šlahora}
%\begin{document}
...
\item Sloveso a zvratná forma jsou identické: \uv{X}/\uv{X se}.
...
\uv{Lokálnost} jádrových hřebů (značena \textit{T}) zobrazuje dominantnost určitých hřebů v textu.  Jedná se o poměr velikosti hřebu ke kardiálnímu číslo jádra:
\begin{equation}
