...
\section*{K. Resler 1948}
	\centering
	\includegraphics[max width=\textwidth,,height=6.5cm, keepaspectratio=true]{imgs-99-priloha-d/l_k_20}
	\caption[Graf koincidence překladu K. Reslera z roku 1948 pro $\alpha = 0{,}2$]
            {Graf koincidence překladu K. Reslera z roku 1948 pro $\alpha = 0{,}2$. \textit{Zdroj:~vlastní.}}
	\label{fig:l_k_20}

	\includegraphics[max width=\textwidth,height=7.5cm, keepaspectratio=true]{imgs-99-priloha-d/l_d_20}
