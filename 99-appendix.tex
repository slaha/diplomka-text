...
\begin{figure}[h]
	{
		\centering
		\includegraphics[max width=\textwidth,height=5.5cm, keepaspectratio=true]{imgs-99-priloha-d/s_d_20}
...
\section*{K. Resler 1948}
	\centering
	\includegraphics[max width=\textwidth,,height=6cm, keepaspectratio=true]{imgs-99-priloha-d/l_k_20}
