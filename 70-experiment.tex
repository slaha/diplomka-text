...
\begin{figure}[H]
	\centering
	\includegraphics[max width=\textwidth,height=160px,keepaspectratio=true]{imgs-70-prakticka/denotation-resler-034}
...
\begin{figure}[H]
	\centering
	\includegraphics[max width=\textwidth,height=180px,keepaspectratio=true]{imgs-70-prakticka/denotation-resler-05}
